...
チャートの配色をカスタマイズできます。以下のカラースキームが利用可能です。

| スキーム | 説明 |
|----------|------|
| **Default** | 標準的な ECharts カラーパレット |
| **Pastel** | 柔らかいパステル調の色 |
| **Vivid** | 鮮やかで彩度の高い色 |
| **Earth** | 自然で落ち着いたアースカラー |
| **Ocean** | 青と緑を基調とした海のイメージ |
| **Sunset** | オレンジと赤を基調とした暖色系 |
| **Monochrome** | グレースケール |
| **Rainbow** | 虹色のフルスペクトラム |
| **Business** | ビジネス向けの落ち着いた青系 |
| **Nature** | 緑を基調とした自然のイメージ |
...
| 比較タイプ | 説明 |
|-----------|------|
| **YoY** | 前年同期比（Year over Year） |
| **MoM** | 前月比（Month over Month） |
| **WoW** | 前週比（Week over Week） |
| **DoD** | 前日比（Day over Day） |
